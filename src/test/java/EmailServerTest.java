...
public class EmailServerTest {
    ...
    @Test
    void testPasswordAuthenticationReturnsCorrectCredentials() throws Exception {
        // Arrange
        ...
        class TestAuthenticator extends Authenticator {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(expectedUsername, expectedPassword);
            }
        }
        ...
        java.lang.reflect.Method method = Authenticator.class.getDeclaredMethod("getPasswordAuthentication");
        method.setAccessible(true);
        PasswordAuthentication auth = (PasswordAuthentication) method.invoke(authenticator);

        // Assert
        assertNotNull(auth, "Authentication object should not be null");
